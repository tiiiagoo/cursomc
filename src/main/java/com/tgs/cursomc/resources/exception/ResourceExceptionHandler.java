package com.tgs.cursomc.resources.exception;
...
import com.tgs.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request){
		...
		for(FieldError fieldErro : e.getBindingResult().getFieldErrors()) {
			err.addError(fieldErro.getField(), fieldErro.getDefaultMessage());
		}		
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
