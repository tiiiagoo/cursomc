...
import com.tgs.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Page<CategoriaDTO>>  findPage(
		...
		Page<CategoriaDTO> listPageDto = pageList.map(categoria -> new CategoriaDTO(categoria));
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO dto){
		Categoria obj = service.fromDtoToObj(dto);
	...
	public ResponseEntity<Void> update(@Valid @RequestBody CategoriaDTO dto, @PathVariable Long id) throws ObjectNotFoundException{
		Categoria obj = service.fromDtoToObj(dto);
		obj.setId(id);
